  ...
  useEffect(() => {
    const fetchRekap = async () => {
      ...
      try {
        ...
        // Simpan data dari Laravel ke state
    ...
    fetchRekap();
  }, [filter, navigate]); // Otomatis panggil ulang jika salah satu isi filter berubah
    ...
    <div className="min-h-screen bg-slate-50 font-sans text-slate-900 pb-10">
      ...
      <header className="bg-white sticky top-0 z-1000 p-6 md:px-12 flex items-center justify-between border-b border-slate-100 shadow-sm">
        ...
        <div className="hidden md:flex items-center gap-2 text-slate-400">
            ...
            <span className="text-xs font-bold uppercase tracking-widest">Tahun {filter.tahun}</span>
        </div>
      </header>
